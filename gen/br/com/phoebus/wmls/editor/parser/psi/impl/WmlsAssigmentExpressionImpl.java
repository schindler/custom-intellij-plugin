...
public class WmlsAssigmentExpressionImpl extends ASTWrapperPsiElement implements WmlsAssigmentExpression {

  public WmlsAssigmentExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WmlsVisitor visitor) {
    visitor.visitAssigmentExpression(this);
  }
